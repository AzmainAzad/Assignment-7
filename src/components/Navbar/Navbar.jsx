    ...
    return (
        <div>
            ...
            <div className="flex items-center justify-between mt-8">
                ...
                <div className="flex items-center gap-5">
                    ...
                    <div className="flex gap-2 border-2 border-gray-400 p-2">
                            ...
                            <img className="10px" src="/src/assets/images/Currency.png" alt="" />
                    </div>
                </div>
            </div>
            ...
            <div className="text-center rounded-3xl bg-cover bg-center mt-10 p-5"
                style={{ backgroundImage: "url('/src/assets/images/bg-shadow.png')" }}>

                    <img className="m-auto" src="/src/assets/images/banner-main.png" alt="" />
